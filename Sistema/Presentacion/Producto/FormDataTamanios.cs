...
{
    public partial class FormDataTamanios : Base.FormData
    {
        ...
        {
            get { return FormDataTamanios.dtSeleccion; }
            set { FormDataTamanios.dtSeleccion = value; }
        }
        ...
        {
            get { return FormDataTamanios.gridSeleccion; }
            set { FormDataTamanios.gridSeleccion = value; }
        }
        private void dtLista_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (GridSeleccion)
            {
                DialogResult dresult = (MessageBox.Show("Selecciono la Categoria: " + dtLista.Rows[e.RowIndex].Cells[1].Value,
        ...
        #endregion 
        public FormDataTamanios()
        {
            InitializeComponent();
        }
        NTamanio addTamanio = new NTamanio();
        private void Lista()
        {
        ...
        private void FormDataTamanios_Load(object sender, EventArgs e)
        {
            this.Lista();
        ...
        {
            FormTamanio frm = new FormTamanio();
            frm.nuevo = true;
            frm.ShowDialog();
            this.Lista();
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                FormTamanio frm = new FormTamanio();
                var t = this.addTamanio.getDatos(int.Parse(this.dtLista.CurrentRow.Cells[0].Value.ToString()));

                frm.editar = true;
              
                frm.txtCodigo.Text ="0000"+ t.dim_codigo.ToString();
                frm.txtNombre.Text = t.dim_nombre;
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.addTamanio.Eliminar(int.Parse(this.dtLista.CurrentRow.Cells[0].Value.ToString()));
                    this.Lista();
        ...
        private void FormDataTamanios_Resize(object sender, EventArgs e)
        {
        ...
        private void FormDataTamanios_FormClosing(object sender, FormClosingEventArgs e)
        {
            GridSeleccion = false;
            this.Hide();
        }
