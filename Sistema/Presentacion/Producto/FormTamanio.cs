...
{
    public partial class FormTamanio : Base.FormMain
    {
        public FormTamanio()
        {
            InitializeComponent();
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.c.Dim_codigo = int.Parse(this.txtCodigo.Text);
                this.c.Dim_nombre = this.txtNombre.Text;
                ...
                if (nuevo && !editar)
                {
                    ...
                    {
                        //insertar
                        this.txtCodigo.Text = this.addTamanio.Insertar(this.c).ToString("000000");
